...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--image_dir',
        type=str,
        default=os.getcwd() + '/training_cropped_images',
        help='Path to folders of labeled images.'
    )
    parser.add_argument(
        '--output_graph',
        type=str,
        default=os.getcwd() + '/retrained_graph.pb',
        help='Where to save the trained graph.'
    )
    parser.add_argument(
        '--output_labels',
        type=str,
        default=os.getcwd() + '/output_labels.txt',
    ...
    parser.add_argument(
        '--bottleneck_dir',
        type=str,
        default=os.getcwd() + '/bottleneck_data',
